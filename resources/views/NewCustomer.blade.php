  ...
  <div style="padding-left:16px" class="container">
    ...
    <form action="{{$url}}" method="post">
      ...
      <div class="container">
        ...
        <input type="text" id="name" name="name" placeholder="Your name.." value="{{$customer->name}}">
        ...
        <input type="text" id="email" name="email" placeholder="Your Email.." value="{{$customer->email}}">
        <span class="text-danger">

        </span>
        <br>
        <label for="contact">Contact</label>
        <input type="text" id="contact" name="contact" placeholder="Your Contact.." value="{{$customer->contact}}">
        <span class=" text-danger">
          @error('contact')
          {{$message}}
          @enderror
        ...
        <input type="text" id="address" name="address" placeholder="Your address.." value="{{$customer->address}}">
        <span class=" text-danger">
          @error('address')
          {{$message}}
          @enderror
        ...
        <input type="date" id="dob" name="dob" placeholder="Your dob.." value="{{$customer->dob}}">
        <span class=" text-danger">
          @error('dob')
          {{$message}}
          @enderror
